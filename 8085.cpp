...
int a=0,b=0,c=0,d=0,e=0,h=0,l=0,sp=0,pc=0,m=0,no_of_1s=0; //all reg have dec values
bool flags[5]; //0=Zero, 1=Carry, 2=Sign, 3=Overflow,   4=Auxiliary carry
